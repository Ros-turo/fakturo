...
async def test_endpoints_security_get(
    unauthorized_user: AsyncClient, router: str, path: str
):
...
async def test_endpoints_security_post(
    unauthorized_user: AsyncClient, router: str, path: str
):
...
async def test_endpoints_security_delete(
    unauthorized_user: AsyncClient, router: str, path: str
):
